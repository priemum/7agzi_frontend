...
// Your existing states and counties data
var states = [
...
// Create a map for state abbreviations to full names
var stateMap = states.reduce((map, state) => {
	map[state.abbrev] = state.name;
	return map;
}, {});

// Transform the counties array to include full state names
var unitedStatesData = arrCounties.map((county) => {
	return {
		state: stateMap[county.state],
		county: county.countyName,
	};
});

// Export the data
export const UnitedStatesData = unitedStatesData;
