...
const EditBanner = ({
	...
	const fileUploadAndResizeThumbNail = (e) => {
		ReactGA.event("Account_Added_Banner", {
			event_category: "Account_Added_Banner",
			event_label: "Account_Added_Banner",
			value: 0, // Optional extra parameters
		});

		ReactPixel.track("Account_Added_Banner", {
			content_name: "Account_Added_Banner",
			content_category: "Account_Added_Banner",
			value: "",
			currency: "",
		});
	...
	const clickSubmit = () => {
		...
		LoyaltyPointsAndStoreStatus(user._id, token, {
			...
			if (data.error) {
				...
				ReactGA.event("Account_Added_Banner_Thumbnail_Successfully", {
					event_category: "Account_Added_Banner_Thumbnail_Successfully",
					event_label: "Account_Added_Banner_Thumbnail_Successfully",
					value: 0, // Optional extra parameters
				});

				ReactPixel.track("Account_Added_Banner_Thumbnail_Successfully", {
					content_name: "Account_Added_Banner_Thumbnail_Successfully",
					content_category: "Account_Added_Banner_Thumbnail_Successfully",
					value: "",
					currency: "",
				});
