...
const MyCalendar = ({ language }) => {
	...
	const handleEventClick = (clickInfo) => {
		...
		return (window.location.href = `/store/admin/single-appointment-details/${clickInfo.event._def.publicId}/${clickInfo.event._def.extendedProps.employeeId}`);
	};
