...
import StoreListPhone from "../components/StoreListBeard/StoreListPhone";
		...
		<MyStoreListWrapper showPagination={selectedGovernorate}>
			<Helmet dir={chosenLanguage === "Arabic" ? "rtl" : "ltr"}>
				...
				{chosenLanguage === "Arabic" ? (
					<title dir='rtl'>أفضل عروض قص اللحية للرجال</title>
				) : (
					<title>Best beardcut offers for Men</title>
				)}
				<meta
					name='description'
					content={
